...
public class Plane {
    public static void main(String[] args) {
        Passenger passenger = new Passenger("John",72000);
        PriorityPassenger priorityPassenger = new PriorityPassenger("Jack",75000,15);
        FirstClassPassenger firstClassPassenger = new FirstClassPassenger("Jane", 70000,20);
