...
class ChessTournamentTest {
    ...
    void testAddPlayersToTeams() {
        ...
        playerA.setName("A");
        playerA.setEmailAddress("a@a.com");
        Player playerB = new Player();
        playerB.setName("B");
        playerB.setEmailAddress("b@b.com");
        Player playerC = new Player();
        playerC.setName("C");
        playerC.setEmailAddress("c@c.com");
        Player playerD = new Player();
        playerD.setName("D");
        playerD.setEmailAddress("d@d.com");
        Player playerE = new Player();
        playerE.setName("E");
        playerE.setEmailAddress("e@e.com");
        Player playerF = new Player();
        playerF.setName("F");
        playerF.setEmailAddress("f@f.com");
        Player playerG = new Player();
        playerG.setName("G");
        playerG.setEmailAddress("g@g.com");
        ...
        assertEquals("e@e.com", chessTournament.getTeams().get(2).getPlayerOne().getEmailAddress());
    }
