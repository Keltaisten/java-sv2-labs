...
class BucketListTest {
    ...
    @Test
    void getDestinationWithKeyword2() {
        assertEquals("Izland", bucketList.getDestinationWithKeyword("ész").get().getName());
    }

    @Test
    void getDestinationWithKeyword3() {
        assertEquals("Lomnici-csúcs", bucketList.getDestinationWithKeyword("mászás").get().getName());
    }
